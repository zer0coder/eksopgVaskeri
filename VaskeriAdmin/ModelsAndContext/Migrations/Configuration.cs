namespace ModelsAndContext.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ModelsAndContext.Context.VaskeriContext>
    {
        ...
        protected override void Seed(ModelsAndContext.Context.VaskeriContext context)
        {
            ...
            // Machines
            Machine machine1 = new Machine() { Id = 1, ServiceID = 1, Number = 1, Type = MachineType.WASHER, InUse = true };
            Machine machine2 = new Machine() { Id = 2, ServiceID = 1, Number = 2, Type = MachineType.WASHER, InUse = false };
            Machine machine3 = new Machine() { Id = 3, ServiceID = 1, Number = 3, Type = MachineType.DRYER, InUse = true };
            ...
            // Vasketider
            WashTime washTime1 = new WashTime() { Id = 1, ServiceID = 1, Description = "Morgen (6-9)", Length = new TimeSpan(3, 0, 0) };
            WashTime washTime2 = new WashTime() { Id = 2, ServiceID = 1, Description = "Formiddag (9-12)", Length = new TimeSpan(3, 0, 0) };
            WashTime washTime3 = new WashTime() { Id = 3, ServiceID = 1, Description = "Eftermiddag(12-15)", Length = new TimeSpan(3, 0, 0) };
            WashTime washTime4 = new WashTime() { Id = 4, ServiceID = 2, Description = "Morgen (7-10)", Length = new TimeSpan(3, 0, 0) };
            WashTime washTime5 = new WashTime() { Id = 5, ServiceID = 2, Description = "Formiddag (10-12)", Length = new TimeSpan(2, 0, 0) };
            WashTime washTime6 = new WashTime() { Id = 6, ServiceID = 2, Description = "Eftermiddag(12-15)", Length = new TimeSpan(3, 0, 0) };
            WashTime washTime7 = new WashTime() { Id = 7, ServiceID = 2, Description = "Aften (15-20)", Length = new TimeSpan(5, 0, 0) };
            ...
            DoneReservation done1 = new DoneReservation() { Id = 1, UID = 1, Reservation = reservation1, DryerProgs = dps1, WashingProgs = wps1 };
            DoneReservation done2 = new DoneReservation() { Id = 2, UID = 2, Reservation = reservation2, WashingProgs = wps2 };
